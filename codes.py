...
st.markdown('<div class="center"><h1>Global Superstore Sales Dashboard<h1></div>', unsafe_allow_html=True)
...
charts_info = [
    ...
    {"type": "bar", "x": "Ship Mode", "y": "Shipping Cost", "title": "Bar Chart", "color": "blue"},
